...
export default function TrainingTheConsultant() {
  return (
    <section className="bg-pink-tint" aria-labelledby="training-consultant-heading">
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
        <div className="mb-10 max-w-2xl">
          <h2 id="training-consultant-heading" className="text-3xl font-bold text-brand-purple sm:text-4xl">
            Training The Consultant
          </h2>
          <p className="mt-3 text-sm font-semibold text-brand-purple sm:text-base">
          ...
          <p className="mt-4 text-sm text-neutral-700 sm:text-base">
            ...
            expertise in the field as they mentor you through the subtleties of business
            analysis, and other essential managerial competencies for corporate organisations.
          </p>
        </div>

        <div className="grid gap-4 rounded-2xl bg-maroon-700 p-4 sm:grid-cols-2 sm:p-6 lg:p-8">
          {consultantCards.map((card) => (
            <div key={card.title} className="min-w-0 rounded-xl p-6">
        ...
        <Button href="#training-consultant" variant="solid-purple" withArrow className="mt-8 w-fit">
          Learn More
        </Button>
      </div>
    </section>
