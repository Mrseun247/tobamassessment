  ...
  return (
    <section className="bg-pink-tint" aria-labelledby="lms-heading">
      <div className="mx-auto grid max-w-7xl items-center gap-10 px-4 py-16 sm:px-6 lg:grid-cols-2 lg:px-8 lg:py-24">
        <div className="mx-auto aspect-square w-full max-w-sm overflow-hidden rounded-full">
          <Image
            src="/images/lms-photo.svg"
        ...
        <div className="flex flex-col gap-5">
          <h2 id="lms-heading" className="text-3xl font-bold text-maroon-900 sm:text-4xl">
          ...
          <div>
            <p className="mb-3 text-sm font-semibold text-maroon-900">
              Some of our courses include:
            </p>
            <BulletList items={courses} columns={2} />
          </div>
